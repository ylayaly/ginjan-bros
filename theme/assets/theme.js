...
theme.Product = (function() {
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _getSuscriptionPrice: function(variant){
      var price = variant.compare_at_price > variant.price ? variant.compare_at_price : variant.price
      var reduce = variant.price;
      if(variant && variant.selling_plan_allocations && variant.selling_plan_allocations.length > 0){
        price = price > variant.selling_plan_allocations[0].compare_at_price ? price : variant.selling_plan_allocations[0].compare_at_price
        reduce = variant.selling_plan_allocations[0].price
      }
    ...
    _updateLiveRegion: function(evt) {
      ...
      var sub_price = this._getSuscriptionPrice(variant)
      $("[data-product-price]").text(sub_price.price)
      $("[data-product-reduce]").text(sub_price.reduce.toFixed(2))

      $("[data-product-regular-price]").text(sub_price.reduce.toFixed(2))
...
theme.ProductRecommendations = (function() {
  function ProductRecommendations(container) {
    ...
    var recommendationsSectionUrl =
      baseUrl +
      '?section_id=product-recommendations-gb&product_id=' +
      productId +
      '&limit=6';
...
$(document).ready(function() {
  ...
  sections.register('product-recommendations-gb', theme.ProductRecommendations);
